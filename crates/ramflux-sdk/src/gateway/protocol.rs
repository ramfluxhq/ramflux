...
pub enum GatewayClientFrame {
    ...
    IdentityRegister { request: SdkMvp1RegisterIdentityRequest },
    PrekeyPublish { request: SdkMvp1PublishPrekeyRequest },
...
pub enum GatewayServerFrame {
    ...
    IdentityRegistered { response: SdkMvp1IdentityRegistrationResponse },
    PrekeyPublished { response: SdkMvp1PrekeyResponse },
    Prekey { response: SdkMvp1PrekeyResponse },
