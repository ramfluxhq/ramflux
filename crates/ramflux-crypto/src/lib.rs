...
pub use signing::{
    ...
    sign_canonical_bytes, sign_canonical_bytes_with_device_branch, sign_canonical_bytes_with_seed,
    sign_protocol_object, sign_protocol_object_with_device_branch, sign_protocol_object_with_seed,
